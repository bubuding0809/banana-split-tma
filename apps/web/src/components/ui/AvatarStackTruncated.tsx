import { Avatar, AvatarStack, type AvatarStackProps, Caption } from '@telegram-apps/telegram-ui'

interface AvatarStackTruncatedProps {
   limit?: number
   children: AvatarStackProps['children']
}
const AvatarStackTruncated = ({ limit = 3, children }: AvatarStackTruncatedProps) => {
